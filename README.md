...
| [`PlanoDeObras/`](PlanoDeObras/) | Manual de execução das obras a partir do que está registado na app: ordem, passos de cada tarefa, ferramentas e material |
| [`ComoIstoSeLiga/`](ComoIstoSeLiga/) | Mapa interactivo das peças de uma aplicação no ar: o que cada uma faz, com quem fala, quanto custa e o que pára se falhar |
